...
# Display the number of rows (observations) and columns (variables) in the dataset
n_obs <- nrow(LifeExp_data)
n_vars <- ncol(LifeExp_data)

# Create a sentence using inline R code
cat("The dataset contains", n_obs, "observations and", n_vars, "variables.")
