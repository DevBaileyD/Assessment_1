...
# Summarize data
summary_table2 <- GDP_vs_pop %>% 
  group_by(Country) %>% 
  summarise(
    mean_population = mean(Population, na.rm = TRUE),
    mean_GDP_per_capita = mean(GDP_per_capita, na.rm = TRUE)
  ) %>% 
  arrange(mean_population)

# Display table with kable
kable(summary_table2, caption = "Summary table of GDP per capita and Population by Country")
```
